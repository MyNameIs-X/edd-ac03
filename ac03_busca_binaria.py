# Pedro Henrique Satana dos Santos - 1801975
...
media_4_6 = (4 + 6) / 2    # preencher com a média exata entre 4 e 6
...
def busca_binaria(lista, alvo):
    ...
    right = len(lista) - 1
    while left <= right:
        center = media(left, right)
        fotografa(center, lista[center])
        if lista[center] == alvo:
            return True

        elif lista[center] > alvo:
            right = center - 1
        else:
            left = center + 1
